...
curated rather than every 5% value from 5 to 100, avoids arbitrary values such as 17%, 23%, or 37%,
and avoids default values above 50% so one objective does not normally dominate a balanced plan.

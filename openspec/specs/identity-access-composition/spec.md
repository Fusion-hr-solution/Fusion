# identity-access-composition Specification

## Purpose

Defines how the Core Employee Details workflow composes Identity-owned access state independently from Core facts, keeps `EmployeeDetails` free of Identity state, and clarifies ownership of Identity workforce-account routes.

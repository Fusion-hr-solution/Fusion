# employee-lifecycle-actions Specification

## Purpose

Defines explicit, effective-dated employee lifecycle actions (terminate, rehire, change-manager) with direct-report blocking, deny-by-default authorization, and removal of legacy status-flip routes.

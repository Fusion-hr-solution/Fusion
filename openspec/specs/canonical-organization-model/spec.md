# canonical-organization-model Specification

## Purpose
Defines the canonical, effective-dated Organization model: stable unit identity, code reservation, type vocabulary, permanent root, and valid as-of hierarchy.
## Requirements

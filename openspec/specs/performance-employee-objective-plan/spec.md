# performance-employee-objective-plan Specification

## Purpose
TBD - created by archiving change performance-p1-4-employee-objective-plan-creation-submission. Update Purpose after archive.
## Requirements

...
namespace EY.HRPlatform.Performance.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260703121040_TemplateApplicabilityDescendantScope")]
    partial class TemplateApplicabilityDescendantScope
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.HRPlatform.Performance.Domain.Entities.ObjectiveTemplateRevision", b =>
                {
                    ...
                    b.Property<string>("ApplicableOrgUnitAndDescendantIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValueSql("'[]'");

...
public sealed class CompleteTenantSetupCommandHandler(
    CoreHRDbContext dbContext) : ICommandHandler<CompleteTenantSetupCommand, Result<TenantSetupStateDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidTenantSetupStateException("Start setup before completing it.");
        }
        ...
        {
            throw new InvalidTenantSetupStateException("Publish the approved structure before completing setup.");
        }

...
public sealed class GetEmployeeReportingLinesByKeyQueryHandler(
    ...
    IWorkforceCanonicalResolver workforceCanonicalResolver) : IQueryHandler<GetEmployeeReportingLinesByKeyQuery, Result<EmployeeReportingLinesDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        var employee = await dbContext.Employees
            .AsNoTracking()
            .FirstOrDefaultAsync(current => current.StableEmployeeKey == request.EmployeeKey, cancellationToken);

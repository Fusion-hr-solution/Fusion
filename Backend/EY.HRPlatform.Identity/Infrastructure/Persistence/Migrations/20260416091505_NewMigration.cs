...
namespace EY.HRPlatform.Identity.Infrastructure.Persistence.Migrations
{
    ...
    public partial class NewMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE identity.""InviteTokens""
                    ADD COLUMN IF NOT EXISTS ""IsRevoked"" boolean NOT NULL DEFAULT FALSE;
            ");

            migrationBuilder.Sql(@"
                ALTER TABLE identity.""InviteTokens""
                    ADD COLUMN IF NOT EXISTS ""RevokedAt"" timestamp with time zone NULL;
            ");

            migrationBuilder.Sql(@"
                CREATE UNIQUE INDEX IF NOT EXISTS ""IX_Tenants_Name_Active""
                ON identity.""Tenants"" (""Name"")

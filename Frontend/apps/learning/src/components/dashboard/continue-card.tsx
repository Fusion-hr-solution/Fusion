...
export function ContinueCard({ training }: ContinueCardProps) {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden border border-border/60 bg-white transition-all duration-300 hover:shadow-lg hover:shadow-black/5 hover:-translate-y-0.5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative flex h-14 w-14 flex-shrink-0 items-center justify-center">
              <svg className="h-14 w-14 -rotate-90" viewBox="0 0 48 48">
                <circle cx="24" cy="24" r="20" fill="none" stroke="hsl(var(--ey-grey-200))" strokeWidth="3" />
                <circle
                  cx="24"
                  cy="24"
                  r="20"
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Chapter {training.currentChapter} of {training.chaptersCount} · {training.duration}
              </p>
            </div>

            {/* Action — the whole card is the link; this is the visual affordance */}
            <span className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg ey-bg-dark text-white shadow-sm transition-all duration-300 group-hover:bg-[hsl(var(--ey-black))] group-hover:shadow-md group-hover:scale-105">

...
export function LanguageSwitcher({
  ...
  if (collapsed) {
    return (
      <div
        className="flex flex-col items-center gap-0.5 rounded-lg border border-border/60 bg-background p-0.5"
        role="group"
        aria-label={t("label")}
      >
        {buttons}
  ...
  return (
    <div className="flex items-center justify-between gap-2">
      ...
      <div
        className="inline-flex gap-0.5 rounded-lg border border-border/60 bg-background p-0.5"
        role="group"
        aria-label={t("label")}
      >
        {buttons}

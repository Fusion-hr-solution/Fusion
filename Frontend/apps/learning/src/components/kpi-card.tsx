...
export function KpiCard({
  ...
  return (
    ...
    >
      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[hsl(var(--ey-grey-100))] transition-transform duration-300 group-hover:scale-105">
        <Icon className="h-5 w-5 text-[hsl(var(--ey-grey-400))]" aria-hidden="true" />
      </div>
      <div>

      ...
      <div className="relative px-8 pt-6 pb-10">
        ...
        >
          ...
          {training.isMandatory && (
            <span className="inline-flex items-center gap-1 rounded-full bg-[hsl(var(--ey-orange-500))]/10 border border-[hsl(var(--ey-orange-500))]/20 px-2.5 py-0.5 text-xs font-semibold text-[hsl(var(--ey-orange-500))]">

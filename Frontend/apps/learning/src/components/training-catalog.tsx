...
import { sortTrainings, TrainingTypeFilter } from "./catalog-helpers";
...
export function TrainingCatalog({ trainings, totalCount, page, pageSize }: TrainingCatalogProps) {
  ...
  const clearAll = useCallback(() => {
    setLevel(null); setTypeFilter(null); setSort("rating"); setInputSearch("");
  ...
  return (
    <>
      ...
      <section className="px-8 py-8">
        ...
        <div className="mt-3 ey-animate-fade-up" style={{ animationDelay: "380ms" }}><TrainingTypeFilter value={typeFilter} onChange={setTypeFilter} /></div>

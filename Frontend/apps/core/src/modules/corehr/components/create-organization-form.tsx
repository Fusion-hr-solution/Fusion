...
export function CreateOrganizationForm() {
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    router.push(`/corehr/organizations/${encodeURIComponent(created.id)}`);
  }

  return (
    <main className="min-h-screen bg-ch-surface p-6 font-chBody text-ch-on-surface lg:p-12">
      <div className="mx-auto max-w-4xl">
        <div className="mb-6">
          <CoreHrBreadcrumbs
            items={[
              { label: "Admin console", href: "/" },
              { label: "Organizations", href: "/corehr/organizations" },
              { label: "Create" },
            ]}
          />
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          <div className="space-y-6 lg:col-span-7">
            <section className="rounded-xl border-0 bg-ch-surface-container-lowest p-8 shadow-sm">
              <form className="space-y-8" onSubmit={onSubmit}>
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border-0 bg-ch-surface-container-low p-4 font-chBody text-ch-on-surface placeholder:text-stone-400 transition-all focus:ring-2 focus:ring-ch-primary-container"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full resize-none rounded-lg border-0 bg-ch-surface-container-low p-4 font-chBody text-ch-on-surface placeholder:text-stone-400 transition-all focus:ring-2 focus:ring-ch-primary-container"
                  />
                </div>
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    disabled={busy}
                    className="flex w-full items-center justify-center gap-3 rounded-lg bg-ch-primary-container px-10 py-4 font-bold text-ch-on-primary-fixed transition-all duration-200 hover:bg-yellow-400 disabled:opacity-60 lg:w-auto"
                  >
          ...
          <div className="space-y-6 lg:col-span-5">
            <div className="rounded-xl bg-ch-surface-container-low p-8">

...
export function Toolbar({
  ...
  const hasFilters =
    ...
    !!access ||
    !!readiness;
  const hasAdvancedFilters = !!managerId || !!readiness;
  ...
  return (
    <TableFilterToolbar
      ...
      primaryFilters={
        <>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant={access ? "secondary" : "outline"}
                size="sm"
                className="gap-1"
              >
                <ListFilter className="size-3.5" />
      ...
      secondaryFilters={
        <>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant={readiness ? "secondary" : "outline"}
                size="sm"
                className="gap-1"
              >
                <ListFilter className="size-3.5" />
                {selectedReadinessOption
                  ? selectedReadinessOption.label
                  : "Record completeness"}
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="start">
      ...
      isAdvancedActive={hasAdvancedFilters}
      onAdvancedToggle={() => setShowAdvanced((current) => !current)}
      clearAction={
        hasFilters ? (
          <Button
            variant="ghost"

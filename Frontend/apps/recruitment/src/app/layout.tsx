        ...
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="container mx-auto flex h-16 items-center px-4">
            ...
            <nav className="flex items-center space-x-6 text-sm font-medium">
              ...
              <a href="/performance" className="transition-colors hover:text-foreground/80 text-foreground/60">Performance</a>
              <a href="/recruitment" className="transition-colors hover:text-foreground/80 text-foreground">Recruitment</a>

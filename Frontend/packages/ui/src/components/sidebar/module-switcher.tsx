      ...
      <Popover.Trigger asChild>
        ...
        >
          ...
          <span className="flex flex-1 items-center gap-1.5 min-w-0">
            <ActiveIcon className="h-4 w-4 text-muted-foreground/60 shrink-0" />
      ...
      <Popover.Portal>
        ...
        >
          ...
          <div className="flex items-center border-b border-border/60 px-3">
            <Search className="h-3.5 w-3.5 text-muted-foreground/60 shrink-0 mr-2" />
            <input
              ref={inputRef}
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              placeholder="Search modules…"
              className="flex-1 py-2.5 text-sm bg-transparent placeholder:text-muted-foreground/60 focus:outline-none"
            />
          </div>

          {/* Module list */}
          <div className="p-1">
            <p className="px-2 py-1.5 text-xs font-bold uppercase tracking-[0.08em] text-muted-foreground/60">
              Navigate to
            </p>
